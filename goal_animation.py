'''
This module is used to animate simple goal scenes and store it to default location animations/raw_goals '' 

For pitch control animations see pc_animation.py

'''


from visualize import save_match_clip
...
#Note: Can take few minutes to run for first time
...
####Code for creating videos for all goals for given gameId
name= {0:'Home' , 1:'Away'}
i = 0
